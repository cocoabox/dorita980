...
var dorita980 = function localV1 (user, password, host, opts) {
  opts = Object.assign({local_address:undefined}, opts);
  ...
  if (opts.local_address) {
    requestOptions.localAddress = opts.local_address;  
  }
